...
If no paramaters are specified, the program will first ask you for
...
as your ke., however it may not contain a carriage return if entered
...
its contents.  The file will be read verbatum (up to the maximum
