...
"NEEDPARAM        =Option %s requires a parameter.",
"MUSTBENUMBER     =Parameter for %s must be a positive number.",
...
"NO_KEYFILE       =Key file %s does not exist.",
...
"OP               =%s oped %s in channel %s with the OP command.",
"DEOP             =%s deoped %s in channel %s with the DEOP command.",
...
"AKICK_ADD        =%s added %s to the auto kick list for channel %s.",
"AKICK_DEL        =%s removed %s from the auto kick list for channel %s.",
...
"FILE_ADD         =%s added file %s (%08x - %s) at privilege %s to public filesystem.",
...
"FILE_PRIV        =%s has re-secured file %s to %s in the public filesystem.",
...
"QLINE            =%s quarantined nickname %s.",
"UNQLINE          =%s unquarantined nickname %s.",
"NOOP             =%s has turned quarantine all IRC ops on server %s %s.",
...
"AKILL_DEL        =%s removed mask %s from the auto kill list.",
"OPERDENY_ADD     =%s added mask %s to the oper deny list (%s).",
"OPERDENY_DEL     =%s removed mask %s from the oper deny list.",
...
"DCC_INIT         =DCC ID %08x initialised with %s (%s).",
...
"REQ_BYNONUSER    =%s command requested by non-existent user %s.",
"REQ_BYNONSERVICE =%s command requested by non-service %s.",
"REQ_FORNONUSER   =%s command requested by %s for non-existent user %s.",
"REQ_TOUSER       =%s command requested by %s to existing user %s.",
"REQ_FORNONCHAN   =%s command requested by %s for non-existent channel %s.",
"REQ_FORNONSERVER =%s command requested by %s for non-existent server %s.",
...
"REC_FORNONUSER   =Received %s from %s for non-existent user %s.",
"REC_FORNONCHAN   =Received %s from %s for non-existent channel %s.",
"REC_NOTINCHAN    =Received %s from %s for %s who is not in channel %s.",
"REC_FORNOTINCHAN =Received %s for %s who is not in channel %s.",
"REC_FORNONSERVER =Received %s from %s for non-existent server %s.",
