...
"; Magick IRC Services", "; (c) 1997-2002 Preston A. Elder <prez@magick.tm>",
	...
	"; leading spaces, you MUST put a '\\' in front of the first space,", "; else leading spaces are stripped.", ";",
	...
	"CANNOT_CONVERT   =Database type $1 invalid (aborting).", "NO_KEYFILE       =Key file $1 does not exist.",
	...
	"                  Closing this window will terminate execution.", "START_EVENTS     =Starting events engine ...",
	"START_CALIBRATE  =Calibrating thread thresholds ...", "START_COMPLETE   =$1 $2 startup procedure complete.",
	"STOP_EVENTS      =Stopping events engine ...", "STOP_COMPLETE    =$1 $2 shutdown procedure complete.", "", ";",
	"; These are used when a command is executed from NickServ.", ";", "[NICKSERV]",
	"REGISTER         =$1 registered nickname $2.", "DROP             =$1 droped nickname $2 ($3 slaves).",
	"LINK             =$1 linked nickname $2 to $3.", "UNLINK           =$1 unlinked nickname $2 from $3.",
	"HOST             =$1 changed their host nickname from $2 to $3.",
	"IDENTIFY         =$1 identified for nickname $2.", "IDENTIFY_FAILED  =$1 failed identification for nickname $2.",
	"GHOST            =$1 killed nickname $2 with the ghost command.",
	"RECOVER          =$1 requested services to recover nickname $2.",
	"SUSPEND          =$1 suspended nickname $2 for $3.", "UNSUSPEND        =$1 unsuspended nickname $2.",
	...
	"; These are used when a command is executed from ChanServ.", ";", "[CHANSERV]",
	"REGISTER         =$1 registered channel $2.", "DROP             =$1 droped channel $2 ($3).",
	"IDENTIFY         =$1 identified as founder for channel $2.",
	"IDENTIFY_FAILED  =$1 failed identification for channel $2.", "SUSPEND          =$1 suspended channel $2 for $3.",
	"UNSUSPEND        =$1 unsuspended channel $2.", "FORBID           =$1 forbade channel $2 from being registered.",
	...
	"; These are used when a command is executed from MemoServ.", ";", "[MEMOSERV]",
	"SEND             =$1 sent a news article to $2.", "DEL              =$1 removed $2 news article(s) from $3.",
	...
	"; These are used when a command is executed from ServMsg.", ";", "[SERVMSG]",
	...
	"; These are used when a command is executed from OperServ.", ";", "[OPERSERV]",
	"MODE             =$1 set mode \"$2\" for $3 with the MODE command.",
	"QLINE            =$1 quarantined nickname $2.", "UNQLINE          =$1 unquarantined nickname $2.",
	...
	"RELOAD           =$1 reloaded the services configuration file.", "UNLOAD           =$1 unloaded language $2.",
	"JUPE             =$1 juped server $2 ($3).", "ONOFF            =$1 TURNED $2 $3 SERVICES.",
	...
	"IGNORED          =Ignored message from $1: $2", "HTM_FORCE        =$1 has forced HTM mode $2.",
	"HTM_ON           =HTM mode $1 ($2 delay) activated ($3Kb/s > $4Kb/s).", "HTM_OFF          =HTM mode deactivated.",
	"HTM_SET          =$1 has set the HTM threshold to $2/s.",
	"HTM_IGNORE       =Ignored message from $1 (HTM mode): $2", "", ";",
	"; These are used when an automated event kicks off.", ";", "[EVENT]",
	"EXPIRE_AKILL     =Expiring akill for $1 ($2) set by $3 for $4.", "EXPIRE_NICK      =Expiring nickname $1 ($2).",
	"EXPIRE_CHAN      =Expiring channel $1 ($2).", "EXPIRE_NEWS      =Expiring news article for channel $1.",
	"LOAD             =Loading databases ...", "SAVE             =Databases saved.",
	"UNBAN            =Removed ban $1 from channel $2 due to timeout ($3).",
	"KILLPROTECT      =Killed/renamed nickname $1 for failure to identify.", "PING             =Pinged all servers.",
	...
	"SIGNAL_IGNORE    =Caught signal #$1, ignoring.", "SIGNAL_SAVE      =Caught signal #$1, saving databases.",
	...
	"LOCK_OPEN        =Failed to open $1 lock for $2.", "LOCK_ACQUIRE     =Failed to acquire $1 lock for $2.",
	...
	"LOCKED_BIN       =System lock values do not match!  Binary recompile required!", "", "[EXCEPTIONS]",
	"MAGICK           =Exception - Thread $1 could not obtain Magick instance.",
	"GENERIC          =Exception - $1:$2:$3:$4", "GENERIC1         =Exception - $1:$2:$3:$4 - $5",
	"GENERIC2         =Exception - $1:$2:$3:$4 - $5/$6", "UNHANDLED        =Unhandled Exception: $1.",
	"UNKNOWN          =Unhandled Exception: no information available.", "DCC_REMOVED      =Corrupt DCC #$1 removed!",
	"NICK_S_REMOVED   =Corrupt stored nickname $1 removed!", "NICK_L_REMOVED   =Corrupt live nickname $1 removed!",
	"CHAN_S_REMOVED   =Corrupt stored channel $1 removed!", "CHAN_L_REMOVED   =Corrupt live channel $1 removed!", "",
	";", "; This is a section for miscellaneous other occurrences.", ";", "[OTHER]",
	...
	"KILL_AKILL       =Killing user $1 on auto kill list $2 ($3).", "KILL_UNKNOWN     =Killed unknown user $1.",
	...
	"REFUSED          =Connection to server $1:$2 refused.", "CLOSED           =Connection to server $1 closed.",
	"SERVER_MSG       =SERVER MESSAGE ($1): $2", "LINK             =Server $1 has linked to the network via. $2.",
	...
	"LOAD_LANGUAGE    =Loaded $1 language file.", "LOAD_HELP        =Loaded $1 help file.",
