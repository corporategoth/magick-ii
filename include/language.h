...
"UNKNOWN_COMMAND    =Unrecognised command %s.  Type /MSG %s HELP for help.",
"UNKNOWN_OPTION     =Unrecognised option %s.  Type /MSG %s HELP %s for help.",
...
"MUSTBEHEX          =You may only specify characters 0-f, %d digits long.",
"MUSTBESIZE         =You must specify a size %s or above.",
"",
";",
...
"NOTONPRIVCOMMITTEE =You may not perform %s on a member of the privileged committees.",
...
";",
"[DCC]",
"COMPLETED          =DCC %s completed (%d bytes transferred).",
"NOACCESS           =DCC %s refused (access denied).",
"NOREQUEST          =DCC %s refused (no request active).",
"TOOBIG             =DCC %s refused (file too big).",
"NOFILE             =DCC %s failed (missing file).",
...
"LOOKUP_PICTURE     =Picture %08x belongs to %s.",
"LOOKUP_PUBLIC      =Public file %08x is %s, available for %s.",
"NLOOKUP_MEMOATTACH =Memo Attachment %08x does not exist.",
"NLOOKUP_PICTURE    =Picture %08x does not exist.",
"NLOOKUP_PUBLIC     =Public file %08x does not exist.",
"NLOOKUP_OTHER      =Unknown file catagory %s.",
...
"HIDE               =%s just changed the host of %s to %s.",
...
"HTM_ON_FORCE       =Entering high-traffic mode forced by %s",
"HTM_DIE            =Cannot recover from high-traffic mode, terminating connection.",
"HTM_OFF            =Resuming standard operation...",
"HTM_OFF_FORCE      =Resuming standard operation forced by %s...",
"HTM_SET            =HTM threshold has been set to %s/s by %s.",
"HTM                =Cannot execute command %s, currently in high-traffic mode - Please try again later.",
"SIGNAL_LOAD        =Recieved signal #%d, server configuration file reloaded.",
"SIGNAL_SAVE        =Recieved signal #%d, database save triggered.",
"SIGNAL_KILL        =PANIC!  Recieved signal #%d, Last function was %s, shutting down!",
"",
"ENTLIST_CLEAR      =Value of %s has been cleared.",
...
";",
"[STATS]",
"GEN_UPTIME         =Services up for %s.",
"GEN_RESET          =Services last reset %s ago.",
"GEN_MAXUSERS       =Maximum Users : %d",
"GEN_USERS          =Current Users : %d (%d op(s))",
"GEN_CLONES         =Current Clones: %d (%d host(s))",
"",
...
"NICK_CMD4          =GHOST         %10d / RECOVER       %10d",
"NICK_CMD5          =SUSPEND       %10d / UNSUSPEND     %10d",
"NICK_CMD6          =FORBID        %10d / GETPASS       %10d",
...
"CHAN_CMD4          =FORBID        %10d / GETPASS       %10d",
"CHAN_CMD5          =MODE          %10d / TOPIC         %10d",
"CHAN_CMD6          =OP            %10d / DEOP          %10d",
"CHAN_CMD7          =VOICE         %10d / DEVOICE       %10d",
"CHAN_CMD8          =KICK          %10d / ANONKICK      %10d",
"CHAN_CMD9          =INVITE        %10d / UNBAN         %10d",
"CHAN_CMD10         =CLEAR         %10d / AKICK         %10d",
"CHAN_CMD11         =LEVEL         %10d / ACCESS        %10d",
"CHAN_CMD12         =GREET         %10d / MESSAGE       %10d",
"CHAN_CMD13         =SET           %10d / NOEXPIRE      %10d",
"CHAN_CMD14         =LOCK          %10d / UNLOCK        %10d",
"",
"OPER_CLONE         =Clone Override entries     : %d",
"OPER_AKILL         =AutoKill entries           : %d",
...
"OPER_CMD4          =PING          %10d / UPDATE        %10d",
"OPER_CMD5          =RELOAD        %10d / UNLOAD        %10d",
"OPER_CMD6          =JUPE          %10d / ON/OFF        %10d",
"OPER_CMD7          =CLONE         %10d / AKILL         %10d",
"OPER_CMD8          =OPERDENY      %10d / IGNORE        %10d",
"OPER_CMD9          =HIDE          %10d",
"",
"OTH_MEMO           =Users with waiting memos   : %d",
...
"USE_NS_STORED      =Stored Nicknames    %5d (%s)",
"USE_CS_STORED      =Stored Channels     %5d (%s)",
"USE_MEMO           =User Memos          %5d (%s)",
"USE_NEWS           =News Articles       %5d (%s)",
"USE_COMMITTEE      =Committees          %5d (%s)",
"USE_OPERSERV       =OperServ Lists      %5d (%s)",
"USE_OTHER          =Other               %5d (%s)",
"USE_TOTAL          =TOTAL               %5d (%s)",
...
"COMM_LIST          =Displaying committees matching %s:",
...
"CHANGE_LEVEL       =Changed entry %s on %s list to level %d.",
...
"DEL_NUMBER         =Deleted entry #%d from %s list.",
...
"DEL2_NUMBER        =Deleted entry #%d from %s %s list.",
...
"",
"NOPIC              =Nickname %s does not have a picture set.",
...
"OPTIONS            =\\       Options: %s",
"HASPIC             =This user has a picture available (%s).  Type /MSG %s SEND %s to download it.",
...
"LVL_AKICK          =AutoKick Maintenance",
"LVL_SUPER          =SuperOp",
...
"OPPED              =You are already oped in channel %s.",
"NOTOPPED           =You are not oped in channel %s.",
"OTH_OPPED          =Nickname %s is already oped in channel %s.",
"OTH_NOTOPPED       =Nickname %s is not oped in channel %s.",
...
"UNSET              =%s for committee %s has been unset.",
"LOCKED             =%s for committee %s has been locked to .%s..",
"UNLOCKED           =%s for committee %s has been unlocked.",
"DEFUNCT            =DEFUNCT",
"",
";",
...
"CFG_LAGCHECK       =Server lag is checked every %s.",
"CFG_SERVERS        =Services have %d possible server(s) to connect to.",
...
"CFG_CYCLE          =Active cycle is %s, and Hyperactive cycle is %s.",
...
"CHAN_PARTTIME      =Default greet delay time is %s.",
...
"QLINE              =Quarantine for nicknames matching %s has been turned %s.",
"NOOP               =IRC Operator quarantine has been turned %s for server %s.",
"KILL               =User %s has been killed (silently).",
"HIDE               =Changed host of nickname %s to %s.",
...
"ATTACHLIMIT        =Nickname %s has reached their limit of file attachments.",
"FORWARD            =[FORWARD: %s] %s",
