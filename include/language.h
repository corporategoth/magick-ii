...
"NLOOKUP_OTHER      =Unknown file category %s.",
...
"SIGNAL_LOAD        =Received signal #%d, server configuration file reloaded.",
"SIGNAL_SAVE        =Received signal #%d, database save triggered.",
"SIGNAL_KILL        =PANIC!  Received signal #%d, Last function was %s, shutting down!",
"",
