...
{
FULLNAME + " - " + SLOGAN, "  (c) 1997-2002 Preston Elder <prez@magick.tm>",
	"  (c) 1998-2002 William King <ungod@magick.tm>", "",
...
{
FULLNAME + " - " + SLOGAN, "", "Programmers: ", "    PreZ           Preston A. Elder        prez@magick.tm",
	"    Ungod          William King            ungod@magick.tm", "", "Design Team: ",
	"    Lord_Striker   Patrick Prins           striker@magick.tm", "", "Special Thanks To:",
	...
	"    sxp            http://www.sourceforge.net/project/?group_id=2280", "---EOM---"};
